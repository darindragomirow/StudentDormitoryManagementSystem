...
{
    public class BreakdownsService : Service<Breakdown>, IBreakdownsService
    {
        public BreakdownsService(IEfRepository<Breakdown> repo, ISaveContext context) : base(repo, context)
        {
        }
    }
}
